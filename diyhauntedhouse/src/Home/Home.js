...
export default class Home extends React.Component {
  ...
  render() {
    return (
      <div>
      <h1>Welcome to the Conservatory DIY Quest</h1>
      {this.props.parentState.userName ?
      <Link to="/conservatory">{this.props.parentState.userName} goes the conservatory</Link>
      :
      ...
      <p>This is a highly repeatable DIY quest. Starting in the Conservatory, you will choose your path. Please know that once you move forward you <b>cannot turn back</b>. You must follow the instructions on each page, RPing out the events and rolling when the page calls for it.</p>
      <p>Eventually you will reach an end of the path, which will take you back to the conservatory. If you leave the quest at anytime, you <b>cannot</b> return to where you left off. You must start at the begining.</p>
      ...
      <h2>How to play</h2>
      <p>As you play through the Conservatory DIY, you must play it in one of the #daervyn overflow or #overflow channels. In order for your runthrough to count, you must tag QM-Cipher when you start a run.</p>
      ...
      <p>When you go to a new area, there will be a description. For example, the first area you start in will be the conservatory. You do not need to copy/paste this description, but you should RP going into that room. This can be as simple as "Bob walks into the Conservatory", but move favor will be given to those that RP.</p>
      ...
      <p>If you accept these terms, please proceed. Don't forget to tag @QM-Cipher in your overflow channel before you start!</p>
      {this.props.parentState.userName ?
      <Link to="/conservatory">{this.props.parentState.userName} goes the conservatory</Link>
      :
      <p>Please type in your Character Name in the top left in order to start.</p>}
